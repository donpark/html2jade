...
(function() {
  var Converter, Ent, FS, Output, Parser, Path, StreamOutput, StringOutput, Writer, applyOptions, doNotEncode, entOptions, nspaces, publicIdDocTypeNames, scope, systemIdDocTypeNames, useTabs,
  ...
  Writer = (function() {
    ...
    Writer.prototype.writeTextLine = function(node, line, output, options) {
      var encodeEntityRef, escapeBackslash, lines, pipe, prefix, trim, trimmed, wrap, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
        _this = this;
      if (options == null) {
        options = {};
      }
