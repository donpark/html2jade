...
(function() {
  var Converter, FS, HE, Output, Parser, Path, StreamOutput, StringOutput, Writer, applyOptions, doNotEncode, entOptions, nspaces, publicIdDocTypeNames, scope, systemIdDocTypeNames, useTabs,
  ...
  Writer = (function() {
          ...
          if (attr && (nodeName = attr.nodeName)) {
            if (nodeName !== 'id' && nodeName !== 'class' && typeof (attr.nodeValue != null)) {
              ...
              if (attrValue.indexOf(this.attrQuote) === -1) {
                ...
                result.push(attr.nodeName + "=" + this.nonAttrQuote + attrValue + this.nonAttrQuote);
              } else {
    ...
    Writer.prototype.writeTextLine = function(line, output, options) {
      ...
      if (line && line.length > 0) {
        if (encodeEntityRef) {
          line = HE.encode(line, entOptions);
        }
        if (escapeBackslash) {
          line = line.replace("\\", "\\\\");
        }
    ...
    Converter.prototype.element = function(node, output) {
      ...
      if (tagName === 'script' || tagName === 'style') {
        ...
        if (doNotEncode) {
          ...
          return output.writeln(tagHead + tagAttr + ' ' + HE.encode(tagText, entOptions));
        }
      } else {
        output.writeln(tagHead + tagAttr);
        return this.children(node, output);
